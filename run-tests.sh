...
const paper = {
  statistics: 164, bibtex: 140, 'xvg-parser': 108, structure: 100,
  'curve-fitting': 81, units: 73, plumed: 72, selection: 67, slurm: 61,
  'error-bars': 60, latex: 59, journals: 53, 'data-cleaning': 51,
