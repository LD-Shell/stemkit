...
(function () {
  ...
  var TOOLS = [
    ...
    { id: 'data-cleaner', name: 'Data Cleaner', cat: 'data', icon: 'fa-broom',
      ...
      tags: 'csv tsv clean tidy normalize normalise log transform scale standardize missing nan null duplicates preprocess',
    ...
    { id: 'stats-calculator', name: 'Statistics Calculator', cat: 'data', icon: 'fa-calculator',
      desc: 'Run t-tests, ANOVA with post-hoc comparisons, correlation and non-parametric tests, with effect sizes, plots and advice on which test fits.',
      tags: 't-test ttest one-sample welch student paired anova post-hoc posthoc tukey games-howell dunn kruskal-wallis correlation pearson spearman mann-whitney wilcoxon p-value pvalue significance effect size cohen confidence interval normality levene descriptive box plot statistics stats',
    ...
    { id: 'outlier-detector', name: 'Outlier Detector', cat: 'data', icon: 'fa-filter',
      ...
      next: [['data-cleaner', 'Transform the column that held them'],
    ...
    { id: 'latex-tables', name: 'Visual LaTeX Tables', cat: 'pub', icon: 'fa-table-cells',
      desc: 'Paste a table from Excel or CSV, preview it, and copy clean LaTeX (booktabs) or Markdown.',
      tags: 'latex table tabular booktabs excel spreadsheet csv markdown',
    ...
    { id: 'doi-fetcher', name: 'DOI to BibTeX', cat: 'pub', icon: 'fa-cloud-arrow-down',
      desc: 'Paste DOIs and get ready-to-use BibTeX entries, looked up through doi.org.',
    ...
    { id: 'journal-abbreviator', name: 'Journal Abbreviator', cat: 'pub', icon: 'fa-spell-check',
      ...
      next: [['bibtex-sanitizer', 'Clean the rest of each entry'],
             ['bibtex-deduplicator', 'Find duplicate entries'],
    ...
    { id: 'sandbox', name: 'Kinetic Sandbox', cat: 'focus', icon: 'fa-atom',
      desc: 'An interactive particle field that scatters from your pointer and gathers while you hold it, a calm visual break.',
      tags: 'particle physics simulation sandbox playground relax break',
