...
(function () {
  ...
  // Written out in full so Tailwind's scanner keeps every class.
  var HUES = {
  ...
  var TOOLS = [
    // ---- Data ----
    { id: 'plot-digitizer', name: 'Plot Digitizer', cat: 'data', icon: 'fa-crosshairs', hue: 'indigo',
    ...
    { id: 'data-cleaner', name: 'Data Cleaner', cat: 'data', icon: 'fa-broom', hue: 'blue',
    ...
    { id: 'stats-calculator', name: 'Statistics Calculator', cat: 'data', icon: 'fa-calculator', hue: 'emerald',
    ...
    { id: 'error-bar-generator', name: 'Error Bar Generator', cat: 'data', icon: 'fa-chart-column', hue: 'teal',
    ...
    { id: 'outlier-detector', name: 'Outlier Detector', cat: 'data', icon: 'fa-filter', hue: 'rose',
    ...
    { id: 'curve-fitter', name: 'Curve Fitter', cat: 'data', icon: 'fa-wave-square', hue: 'green',
    ...
    { id: 'plot-builder', name: 'Plot Builder', cat: 'data', icon: 'fa-chart-area', hue: 'sky',
    ...
    { id: 'xvg-visualizer', name: 'XVG Visualizer', cat: 'data', icon: 'fa-file-csv', hue: 'indigo',
    ...
    // ---- Compute ----
    { id: 'structure-inspector', name: 'Structure Inspector', cat: 'comp', icon: 'fa-cube', hue: 'amber',
    ...
    { id: 'coordinate-manipulator', name: 'Coordinate Manipulator', cat: 'comp', icon: 'fa-arrows-up-down-left-right', hue: 'purple',
    ...
    { id: 'scientific-converter', name: 'Scientific Converter', cat: 'comp', icon: 'fa-bolt', hue: 'orange',
    ...
    { id: 'script-generator', name: 'MD Workflow Generator', cat: 'comp', icon: 'fa-terminal', hue: 'rose',
    ...
    // ---- Writing ----
    { id: 'latex-formatter', name: 'Equation Formatter', cat: 'pub', icon: 'fa-square-root-variable', hue: 'sky',
    ...
    { id: 'latex-tables', name: 'Visual LaTeX Tables', cat: 'pub', icon: 'fa-table-cells', hue: 'teal',
    ...
    { id: 'doi-fetcher', name: 'DOI to BibTeX', cat: 'pub', icon: 'fa-cloud-arrow-down', hue: 'indigo',
    ...
    { id: 'bibtex-deduplicator', name: 'BibTeX Deduplicator', cat: 'pub', icon: 'fa-copy', hue: 'violet',
    ...
    { id: 'bibtex-sanitizer', name: 'BibTeX Sanitizer', cat: 'pub', icon: 'fa-broom', hue: 'sky',
    ...
    { id: 'journal-abbreviator', name: 'Journal Abbreviator', cat: 'pub', icon: 'fa-spell-check', hue: 'pink',
    ...
    // ---- Focus ----
    { id: 'pomodoro', name: 'Ambient Pomodoro', cat: 'focus', icon: 'fa-stopwatch', hue: 'fuchsia',
    ...
    { id: 'decision', name: 'Decision Matrix', cat: 'focus', icon: 'fa-code-branch', hue: 'indigo',
      ...
      next: [['pomodoro', 'Start a focused session'],
             ['sandbox', 'Take a short visual break']] },
    { id: 'sandbox', name: 'Kinetic Sandbox', cat: 'focus', icon: 'fa-atom', hue: 'cyan',
  ...
  function iconChip(t, cls) {
    return '<span class="' + cls + ' ' + HUES[t.hue] + '"><i class="fa-solid ' + t.icon + '" aria-hidden="true"></i></span>';
  }
