...
MDAnalysis~\cite{michaudagrawal2011} as the reference framework,
...
is where that demonstration usually fails to happen. None of these errors is
visible by inspection; a $p$-value floored at zero looks like a very strong
result. Authors of small, rarely reviewed in-house analysis code would be well
advised to check their numerics against an independent implementation before
reporting output.
