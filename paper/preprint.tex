...
skips all non-numeric lines would, loses precisely the metadata that identifies
...
language, which is the step at which reproducibility is most often lost. The emitted
