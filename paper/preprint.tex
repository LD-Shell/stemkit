...
\url{https://github.com/LD-Shell/stemkit} (release tag \texttt{v0.1.0}) \\
\hline
...
\url{https://github.com/LD-Shell/stemkit} and archived for citation. It is not
used in a commercial setting and has not led to a spin-off company; the
