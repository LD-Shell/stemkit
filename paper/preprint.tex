...
\node[box, right=of browser] (node) {\textbf{Node.js host}\\[1pt]
  ...
  \footnotesize 1077-test Jest suite; smoke test\\
...
\node[wide, below=of $(browser.south)!0.5!(node.south)$, yshift=-1mm] (core)
  {\textbf{\texttt{@stemkit/core}}\\[1pt]
   \footnotesize 16 DOM-free domain modules, aggregated by \texttt{src/core/index.js}};
...
MD workflow generator & \texttt{slurm}, \texttt{plumed} & SLURM scripts for GROMACS and LAMMPS; PLUMED input \\
...
objects, leaving presentation to the caller. The remaining modules support manuscript preparation: LaTeX and Markdown
